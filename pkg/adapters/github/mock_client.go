...
func (mr *MockClientMockRecorder) GetFileContent(ctx, owner, repo, path, ref interface{}) *gomock.Call {
...
func (mr *MockClientMockRecorder) ListTags(ctx, owner, repo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
